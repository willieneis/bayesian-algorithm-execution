...
while dij_idx < len(true_ep.x):
    ...
    # Replace x_next with x_next in true dijkstra sequence
    x_next = true_ep.x[dij_idx]
    dij_idx += 1
    ...
    if plot:            
        ...
        neatplot.save_figure(f'exact_{i}')
        #plt.pause(0.0001)
        #inp = input("Paused")
...
neatplot.save_figure(f'final_plot')
